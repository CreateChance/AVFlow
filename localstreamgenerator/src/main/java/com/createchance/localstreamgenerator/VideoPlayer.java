...
public class VideoPlayer {
    ...
    /**
     * Callback invoked when rendering video frames.  The VideoPlayer client must
     ...
     * @throws IOException
     */
    public VideoPlayer(File sourceFile, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
    ...
    public static class PlayTask implements Runnable {
         ...
         */
        public PlayTask(VideoPlayer player, PlayerFeedback feedback) {
            mPlayer = player;
            mFeedback = feedback;
