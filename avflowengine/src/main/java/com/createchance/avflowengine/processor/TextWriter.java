...
public class TextWriter {
    ...
    void setText(String fontPath, String text, int posX, int posY, int textSize, float red, float green, float blue, Bitmap background) {
        mText = new Text();
    ...
    void setParams(int posX, int posY, float red, float green, float blue) {
        if (mText != null) {
