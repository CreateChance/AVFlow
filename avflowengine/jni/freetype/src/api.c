...
Java_com_createchance_avflowengine_AVFlowEngine_test(JNIEnv *env, jobject obj, jstring jFontPath,
                                                     jstring jText) {
    FT_Library library;
    FT_Face face;
    ...
    jcharArray result = (*env)->NewCharArray(env, WIDTH * HEIGHT);
    (*env)->SetCharArrayRegion(env, result, 0 , WIDTH * HEIGHT, image);
}
